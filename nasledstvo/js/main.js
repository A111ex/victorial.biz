$(function() {
    ...
    $(".call_form").submit(function() {
        var form = $(this);
        var error = false;
        form.find('input[type=text]').each(function() { // Р С—РЎР‚Р С•Р В±Р ВµР В¶Р С‘Р С Р С—Р С• Р С”Р В°Р В¶Р Т‘Р С•Р СРЎС“ Р С—Р С•Р В»РЎР‹ Р Р† РЎвЂћР С•РЎР‚Р СР Вµ
            if ($(this).val() == '') {
                // $(this).addClass('error')  
                error = true;
            }
...
// var i = 1;
//  var timer = setInterval(function() { $(".chel").text(i++) }, 100000);
