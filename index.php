                    ...
                    <div class="items">
                        <div class="row clearfix">
                            <div class="bl fl-l">
                                ...
                                <p>Ваш бывший супруг не ожидает от Вас активной защиты. Вы получаете преимущество в виде команды опытных юристов и адвокатов, знающих тактику и методы ведения дела в суде.</p>
                            </div>
                            <div class="bl fl-r">
                        ...
                        <div class="row clearfix">
                            <div class="bl fl-l">
                                ...
                                <p>Вы можете лично не участвовать в суде, переговорах и доверить полностью решение вопроса профессионалам, сохраняя абсолютное спокойствие.</p>
                            </div>
                            <div class="bl fl-r">
                                <div class="t">Конфиденциальность </div>
                                <p>
                                    Информация по Вашему делу является строго конфиденциальной и не подлежит разглашению третьим лицам ни при каких обстоятельствах.</p>
                            </div>
                        </div>
                       <!--  <div class="row clearfix">
                            <div class="bl">
